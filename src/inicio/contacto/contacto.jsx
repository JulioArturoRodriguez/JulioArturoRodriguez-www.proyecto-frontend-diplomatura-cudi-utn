...
import './contacto.css'; // Para estilos personalizados de la página
...
const Contact = () => {
    ...
    const [submitted, setSubmitted] = useState(false); // Para manejar si el formulario fue enviado
    ...
    <input
        type="text"
        id="name"
        className="form-control input-custom"  // Aplica la clase personalizada
        value={name}
    ...
    <div className="form-group d-flex justify-content-between">
        ...
        <input
            type="email"
            id="email"
            className="form-control input-email-custom"  // Aplica la clase personalizada
            value={email}
